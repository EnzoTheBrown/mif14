...
/* package MIF14-0.1.0.0 */
#define VERSION_MIF14 "0.1.0.0"
#define MIN_VERSION_MIF14(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "MIF14-0.1.0.0"

#define CURRENT_PACKAGE_KEY "MIF14-0.1.0.0"
